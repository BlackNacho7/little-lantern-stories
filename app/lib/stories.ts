...
export function getStories(): Story[] {
  return localStories.filter((s): s is Story => s !== undefined);
}

export function getStoryBySlug(slug: string): Story | undefined {
  return localStories.filter((s): s is Story => s !== undefined).find((s) => s.slug === slug);
}
...
export const localStories = [
  {    slug:"bennys-cozy-bed",
    ...
    content: `Benny had a bed. And not just any bed — the coziest, softest, warm-est bed in the whole wide world.
...
And Benny slept. Safely. Warmly. Cozily.`,
  ...
  {    slug:"wheres-my-family",
    ...
    content: `Little Rabbit had a family. Mama Rabbit and Papa Rabbit and Grandma Rabbit too! They lived in a cozy burrow under the big oak tree.
...
But he knew: even if he wandered again, his family would always be there. And they would always, always find each other.`,
  ...
  {    slug:"ollies-noisy-morning",
    ...
    content: `Ollie was a fluffy yellow duckling with bright orange feet.
...
Because the best part of every morning? Was the sounds. Splash! Quack! Crunch! And Mama Duck's hug.`,
  ...
  {    slug:"the-curious-kitten",
    ...
    content: `Whiskers was the smallest kitten in her family. She had soft gray fur and the biggest, roundest eyes.
...
And from that day on, the big cats didn't mind Whiskers' questions quite so much. Because sometimes, the best part of being curious isn't the answers — it's all the wonderful things you get to discover.`,
  ...
  {    slug:"the-sleepy-star",
    ...
    content: `High up in the velvet sky, there lived a little star named Twinkle. She was one of the smallest stars in the whole sky — but she had the warmest, brightest glow of all.
...
And Twinkle learned something very important: rest is not lazy. Rest is how we fill back up so we can glow again.`,
  ...
  {    slug:"the-grumpy-garden",
    ...
    content: `Oliver had been a gardener for a very, very long time. He knew everything about growing flowers — when to plant them, how much water to give them, when to trim the leaves.
...
And Oliver learned something important: sometimes when we're grumpy, we don't need to be alone. We just need someone kind to sit with us until we're ready to smile again.`,
  ...
  {    slug:"marina-makes-a-friend",
    ...
    content: `Marina was a quiet little girl who loved to watch. While other children ran and shouted on the playground, Marina would sit on the bench and watch the butterflies dance.
...
And it all started with a tiny seed, a kind heart, and the courage to take the first quiet step.`,
  ...
  {    slug:"a-home-for-millie",
    ...
    content: `Millie was a small, dusty-brown moth with delicate wings. And Millie was very, very lost.
